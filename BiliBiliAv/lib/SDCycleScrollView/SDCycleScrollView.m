...
-(void)setPageControlDotPointY:(CGFloat)pageControlDotPointY
{
    _pageControlDotPointY = pageControlDotPointY;
    [self setupPageControl];
    if ([self.pageControl isKindOfClass:[TAPageControl class]]) {
        //TAPageControl *pageContol = (TAPageControl *)_pageControl;
        [self layoutSubviews];
...
-(void)setCurrentDotIamge:(UIImage *)currentDotIamge
{
    _currentDotIamge = currentDotIamge;
    if ([self.pageControl isKindOfClass:[TAPageControl class]]) {
        TAPageControl *pageControl = (TAPageControl *)_pageControl;
        pageControl.currentDotImage = currentDotIamge;
    }
}
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case SDCycleScrollViewPageContolStyleAnimated:
        {
            ...
            pageControl.dotImage = self.dotImage;
            pageControl.currentDotImage = self.currentDotIamge;
