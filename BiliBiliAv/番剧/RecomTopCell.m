...
-(void)layout
{
    ...
    self.recomContentView.sd_layout.leftSpaceToView(contentView,0).topSpaceToView(contentView,0).rightSpaceToView(contentView,0).bottomSpaceToView(contentView,0);
    ...
    [self setupAutoHeightWithBottomView:self.subTitleLabel bottomMargin:8];
}
