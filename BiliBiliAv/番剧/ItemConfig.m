...
-(NSArray *)items
{
    NSArray * images = @[@"home_region_icon_33@2x",@"home_region_icon_32@2x",@"home_region_icon_153@2x",@"home_region_icon_152@2x"];
    NSArray * titles = @[@"连载动画",@"完结动画",@"国产动画",@"官方延伸"];
...
-(CGFloat)cellHeight
{
    ...
    return lineNum*(itemWidth+titleHeight)+padding*2+8;
}
